    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>LIST DATA CABANG</strong> </h2>
                        <ul class="header-dropdown">
                            <li class="dropdown"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <i class="zmdi zmdi-more"></i> </a>
                                <ul class="dropdown-menu slideUp">
                                    <li>
                                        <a href="{{route('page.master.cabang_page_add')}}">Cabang baru</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
...
<script type="text/javascript" src="https://cdn.datatables.net/v/dt/dt-1.11.3/datatables.min.js"></script>
    ...
    $(document).ready(function(){
      var table = $('#example').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ route('page.master.cabang_list') }}",
          columns: [
              {data: 'namacabang', name: 'namacabang'},
              {data: 'nmkepala', name: 'nmkepala'},
            ...
            //   {data: 'kecamatan', name: 'kecamatan.name'},
            //   {data: 'kelurahan', name: 'kelurahan.name'},
            //   {
            //       data: 'option', 
            //       name: 'option', 
            //       orderable: true, 
