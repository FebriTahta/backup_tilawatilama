            ...
            <div class="row clearfix">
                <div class="col-lg-5 col-md-5 col-sm-12">
                    ...
                    <ul class="breadcrumb padding-0">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Cetak</a></li>
                        <li class="breadcrumb-item active">Syahadah Belakang</li>
                    </ul>
                </div>            
...
<div class="modal fade" id="modal-print" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="{{route('cetak_belakang')}}" enctype="multipart/form-data" id="formaddkategori">@csrf
                <div class="modal-body"> 
                    <div class="form-group">
                        <input type="hidden" id="pelatihan_id" name="pelatihan_id" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <input type="text" id="pelatihans" name="pelatihan" class="form-control" readonly required>
                    </div>
                </div>
                <div class="modal-footer">
