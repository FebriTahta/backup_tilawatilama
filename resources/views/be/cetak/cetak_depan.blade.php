...
<body>
	<style>
		...
		<div class="print">
			...
			class="dalam">
				<tbody>
				<tr class="atas" style="height: 23px;">
				...
				<td class="atas" style="width: 750px; height: 23px; text-transform: uppercase" >{{ $item->tmplahir }}, {{ Carbon\Carbon::parse($date)->isoFormat('D MMMM Y') }}&nbsp;</td>
				<td class="atas" style="width: 52px; height: 23px;">&nbsp;</td>
				</tr>
			...
			>
				...
				<td class="bawah" style="width: 210px; height: 27px;">&nbsp;</td><?php $lokasicetak = strtolower($item->pelatihan->cabang->kota)?>
				...
				<td class="atas" style="width: 241px; height: 5px;"> {{$item->pelatihan->cabang->nmkepala}} </td>
				</tr>
				<tr style="height: 4px;">
