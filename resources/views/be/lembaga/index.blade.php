    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>LIST DATA LEMBAGA</strong> </h2>
...
<script type="text/javascript" src="https://cdn.datatables.net/v/dt/dt-1.11.3/datatables.min.js"></script>
    ...
    $(document).ready(function(){
      var table = $('#example').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ route('page.master.lembaga_list') }}",
          columns: [
                {data: 'id', name: 'id'},
                {data: 'nm_lembaga', name: 'nm_lembaga'},
                {data: 'nm_kepala', name: 'nm_kepala'},
                {data: 'kategori', name: 'kategori'},
                {data: 'alamat', name: 'alamat'},
                {data: 'kota', name: 'kota'},
                {data: 'propinsi', name: 'propinsi'},
                {data: 'total_guru', name: 'total_guru'},
                {data: 'total_santri', name: 'total_santri'},
